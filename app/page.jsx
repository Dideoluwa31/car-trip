  ...
  return (
    ...
    <div className="h-screen bg-img-home">
        <div className="h-full bg-black/50 flex justify-center items-center">
            <blockquote className="lg:w-[620px] flex flex-col gap-8 px-2 md:px-6 lg:px-0">
                <h1 className="text-6xl text-white text-center font-bold">Get the <span className="text-yellow-600">comfort</span> you deserve with our rentals whether it's for <span className="text-yellow-600">luxury</span> or on your <span className="text-yellow-600">temporal stay</span></h1>
    ...
    <div className="min-h-[320px] md:min-h-[420px] grid md:grid-cols-2 gap-3 md:gap-6 py-20 px-2 md:px-6 lg:px-12">
        <div className="flex flex-col justify-around gap-2 bg-[#EEEEEE] rounded-lg px-3">
            ...
            <h3 className="text-3xl md:text-4xl text-[#DC5F00] uppercase">Enjoy Amazing Discounts</h3>
        ...
        <div className="flex flex-col justify-around gap-2 bg-[#EEEEEE] rounded-lg px-3">
            ...
            <p className="text-xl text-gray-700">
                Get NGN50,000 for every referral on your link. Make sure you join our <a href="https://x.com/earlycodetech" className="text-[#DC5F00]">X community</a> to learn to get more referrals.
            </p>
        </div>
    </div>
